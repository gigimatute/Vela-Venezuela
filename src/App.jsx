...
const MEDICOS = [
  {
    id: "giulliana",
    nombre: "Dra. Guilliana Matute",
    especialidad: "Médico Cirujano",
    avatar: "👩‍⚕️",
    disponibilidad: "Lunes a Domingo · 7:00 AM – 6:00 PM",
    meet: "https://meet.google.com/asg-dpce-kuw",
  },
];
...
const SINTOMAS = {
  fiebre: {
    ...
    respuesta: () => `La fiebre es una respuesta natural del cuerpo ante infecciones o inflamaciones. Una temperatura entre 37.5°C y 38.5°C generalmente indica que tu sistema inmune está trabajando.\n\n• Toma abundante agua y líquidos\n• Descansa en un lugar fresco\n• Paracetamol puede ayudar a bajar la temperatura\n\nContacta a nuestro equipo médico si la fiebre supera 39°C o dura más de 3 días. 🩺`,
  },
  cabeza: {
    keywords: ["cabeza", "migraña", "cefalea", "jaqueca"],
    respuesta: () => `El dolor de cabeza tiene muchas causas posibles: tensión muscular, deshidratación, estrés o presión arterial alterada.\n\n• Bebe al menos 2 litros de agua al día\n• Descansa en un lugar oscuro y silencioso\n• Evita pantallas por un rato\n\nPara una evaluación completa, nuestro equipo médico puede ayudarte. 🩺`,
  },
  presion: {
    keywords: ["presión", "presion", "hipertensión", "hipertension", "mareo", "mareado"],
    respuesta: () => `Los síntomas relacionados con la presión arterial merecen atención médica oportuna.\n\n• Siéntate o recuéstate en un lugar tranquilo\n• Evita la sal, el café y el estrés\n• Si tienes tensiómetro, mide tu presión\n\nNuestro equipo médico puede evaluarte y orientarte en el manejo. 🩺`,
  },
  estomago: {
    keywords: ["estómago", "estomago", "náuseas", "nauseas", "vómito", "vomito", "diarrea", "barriga"],
    respuesta: () => `Los problemas gastrointestinales son muy comunes y generalmente se resuelven en pocos días.\n\n• Hidratación es lo más importante\n• Dieta blanda: arroz blanco, pollo hervido, tostadas\n• Evita lácteos, grasas y picantes\n\nContacta a nuestro equipo médico si la diarrea o vómitos duran más de 48 horas. 🩺`,
  },
  gripe: {
    keywords: ["gripe", "resfriado", "tos", "congestión", "congestion", "garganta"],
    respuesta: () => `Los síntomas de gripe o resfriado suelen mejorar en 5–7 días con cuidados en casa.\n\n• Descansa mucho y toma abundantes líquidos\n• Miel con limón y jengibre puede aliviar la garganta\n• Paracetamol para el malestar y la fiebre\n\nContacta a nuestro equipo médico si los síntomas empeoran después del día 3. 🩺`,
  },
  diabetes: {
    keywords: ["diabetes", "azúcar", "azucar", "glucosa", "insulina"],
    respuesta: () => `La diabetes requiere seguimiento médico regular para un manejo adecuado.\n\n• Monitorea tu glucosa regularmente\n• Mantén horarios regulares de comida\n• Evita azúcares simples y harinas refinadas\n\nNuestro equipo médico puede orientarte en el control de tu diabetes. 🩺`,
  },
};
...
function getRespuesta(texto) {
  ...
  for (const [, data] of Object.entries(SINTOMAS)) {
    if (data.keywords.some(k => lower.includes(k))) return data.respuesta();
  }
  return `Gracias por compartir cómo te sientes. Los síntomas que describes merecen atención médica personalizada.\n\n• Mantente bien hidratado/a\n• Descansa lo que necesites\n• Observa si los síntomas mejoran o empeoran\n\nPara un diagnóstico certero, agenda una consulta con nuestro equipo médico. 🩺`;
}

function simular(ms = 1200) { return new Promise(r => setTimeout(r, ms)); }
  ...
  return (
    <div style={{ background: T.primaryLt, border: `1px solid ${T.primary}33`, borderRadius: 12, padding: "10px 14px", marginBottom: 14, display: "flex", gap: 10, alignItems: "flex-start" }}>
      ...
      <p style={{ ...F.sm, fontFamily: F.family, color: T.primaryDk, margin: 0, lineHeight: 1.5 }}>
        <strong>Vela no reemplaza al médico.</strong> Ofrecemos información general y orientación. Para diagnósticos, prescripciones y tratamientos, consulta con nuestro equipo médico.
      </p>
    </div>
  );
}
  ...
  const pasos = [
    {
      ...
      campos: [
        { key:"nombre", label:"¿Cómo te llamas?", tipo:"text", ph:"Tu nombre completo" },
    ...
    },
    {
      ...
      campos: [
        ...
        { key:"condiciones", label:"¿Tienes alguna condición crónica? (opcional)", tipo:"textarea", ph:"ej. Diabetes, hipertensión... o escribe 'ninguna'" },
  ...
  return (
    <div style={{ minHeight:"100vh", background:`linear-gradient(160deg, ${T.bgSubtle} 0%, ${T.bgBase} 55%)`, padding:"0 20px 48px", fontFamily:F.family }}>
      ...
      <div style={{ paddingTop:64, paddingBottom:36, textAlign:"center" }}>
        ...
        <p style={{ ...F.body, fontFamily:F.family, color:T.textBody, margin:"0 0 2px" }}>Información médica confiable</p>
      ...
      <button style={S.btnPrimary} onClick={siguiente}>{paso < pasos.length-1 ? "Continuar →" : "Comenzar con Vela 🕯️"}</button>
      <p style={{ ...F.sm, fontFamily:F.family, color:T.textGray, textAlign:"center", marginTop:20, lineHeight:1.6 }}>
        🛡️ Vela <strong>no es un servicio de emergencias</strong>. En emergencias llama al 911.
      </p>
    </div>
  );
}
  ...
  return (
    <div style={{ fontFamily:F.family }}>
      ...
      <div style={{ background:`linear-gradient(145deg, ${T.bgSubtle} 0%, #ECFDF5 100%)`, padding:"56px 20px 28px", borderRadius:"0 0 32px 32px", marginBottom:18 }}>
        ...
        <p style={{ ...F.body, fontFamily:F.family, color:T.textBody, margin:0 }}>¿Cómo te sientes hoy? Estamos aquí para orientarte.</p>
      </div>
      ...
      <div style={{ padding:"0 16px" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10, marginBottom:18 }}>
          {[
            ...
            { icon:"🩺", titulo:"Agendar consulta", sub:"Con nuestro equipo médico", color:T.goldLt, tab:"cita" },
          ].map(s => (
        ...
        <div style={{ ...S.card, background:`linear-gradient(135deg, ${T.bgSubtle}, #ECFDF5)`, border:`1px solid ${T.primaryLt}` }}>
          <p style={{ ...F.label, fontFamily:F.family, color:T.primary, marginBottom:14 }}>Nuestro equipo médico</p>
          {MEDICOS.map(m => (
            <div key={m.id} style={{ display:"flex", alignItems:"center", gap:12, padding:"8px 0", borderBottom:`1px solid ${T.primaryLt}` }}>
              <div style={{ width:40, height:40, borderRadius:14, background:`linear-gradient(135deg, ${T.primary}, ${T.primaryDk})`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:20, flexShrink:0 }}>{m.avatar}</div>
              <div>
                <p style={{ ...F.h3, fontFamily:F.family, color:T.textHd, margin:"0 0 2px", fontSize:14 }}>{m.nombre}</p>
                <p style={{ ...F.sm, fontFamily:F.family, color:T.textGray, margin:0 }}>{m.especialidad}</p>
              </div>
            </div>
          ))}
          <button onClick={() => onNavegar("cita")} style={{ ...S.btnPrimary, marginTop:14 }}>Agendar consulta →</button>
        </div>

        {/* Tips */}
        {[
          { icon:"💧", titulo:"Hidratación", texto:"Toma al menos 8 vasos de agua al día." },
          { icon:"😴", titulo:"Sueño reparador", texto:"Dormir 7–8 horas reduce el riesgo de hipertensión y diabetes." },
          { icon:"🥗", titulo:"Alimentación", texto:"Incluye vegetales, proteínas y reduce el azúcar y la sal." },
        ].map((i,idx) => (
        ...
        <div style={{ background:"#FEF2F2", border:"1px solid #FECACA", borderRadius:14, padding:16, marginBottom:14 }}>
          <p style={{ ...F.sm, fontFamily:F.family, color:"#991B1B", margin:0, lineHeight:1.6, fontWeight:600 }}>
            🚨 <strong>¿Es una emergencia?</strong> Vela no atiende emergencias. Llama al <strong>911</strong> o ve al hospital más cercano.
          </p>
        </div>
...
// ─── CONSULTAR ────────────────────────────────────────────────────────────────
function Consultar({ state, dispatch, onNavegar }) {
  const { perfil, sintomas } = state;
    ...
    <div style={{ fontFamily:F.family }}>
      ...
      <div style={{ padding:"0 16px" }}>
        ...
        <div style={S.card}>
          ...
          {cargando ? <Cargando texto="Consultando información…"/> : <button style={S.btnPrimary} onClick={consultar}>Consultar 🔍</button>}
          {respuesta && (
            <div style={{ marginTop:18, background:T.bgMuted, borderRadius:16, padding:18, borderLeft:`4px solid ${T.primary}` }}>
              ...
              <button onClick={() => onNavegar("cita")} style={S.btnGold}>🩺 Agendar consulta con nuestro equipo médico</button>
            </div>
          )}
        </div>
        {sintomas.length > 0 && (
...
function AgendarCita({ perfil }) {
  ...
  const horas = ["7:00 AM","8:00 AM","9:00 AM","10:00 AM","11:00 AM","12:00 PM","1:00 PM","2:00 PM","3:00 PM","4:00 PM","5:00 PM","6:00 PM"];
  const medico = MEDICOS.find(m => m.id === medicoId);
  function campo(k, v) { setForm(p => ({...p, [k]:v})); }

  const WHATSAPP_LINK = `https://wa.me/58XXXXXXXXXX?text=Hola%2C%20quisiera%20confirmar%20mi%20cita%20con%20${encodeURIComponent(medico?.nombre||"el médico")}%20para%20el%20${encodeURIComponent(form.fecha)}%20a%20las%20${encodeURIComponent(form.hora)}`;
  ...
  return (
    <div style={{ fontFamily:F.family }}>
      ...
      <div style={{ background:`linear-gradient(145deg, ${T.bgSubtle} 0%, #ECFDF5 100%)`, padding:"56px 20px 24px", borderRadius:"0 0 32px 32px", marginBottom:18 }}>
        ...
        <p style={{ ...F.body, fontFamily:F.family, color:T.textBody }}>Elige tu médico y agenda tu cita desde casa 🕯️</p>
      </div>

      <div style={{ padding:"0 16px" }}>

        {/* PASO 0 — Elegir médico */}
        {paso === 0 && (
          <>
            <p style={{ ...F.label, fontFamily:F.family, color:T.primary, marginBottom:12 }}>Selecciona tu médico</p>
            {MEDICOS.map(m => (
              <div key={m.id}
                onClick={() => setMedicoId(m.id)}
                style={{ ...S.card, cursor:"pointer", transition:"all 0.2s",
                  border: medicoId===m.id ? `2px solid ${T.primary}` : `1px solid rgba(167,243,208,0.4)`,
                  boxShadow: medicoId===m.id ? `0 4px 20px rgba(5,150,105,0.15)` : S.card.boxShadow,
                }}>
                <div style={{ display:"flex", alignItems:"center", gap:14 }}>
                  <div style={{ width:56, height:56, borderRadius:18, background:`linear-gradient(135deg, ${T.primary}, ${T.primaryDk})`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:26, flexShrink:0 }}>{m.avatar}</div>
                  <div style={{ flex:1 }}>
                    <p style={{ ...F.h3, fontFamily:F.family, color:T.textHd, margin:"0 0 2px" }}>{m.nombre}</p>
                    <p style={{ ...F.sm, fontFamily:F.family, color:T.primary, fontWeight:600, margin:"0 0 2px" }}>{m.especialidad}</p>
                    <p style={{ ...F.sm, fontFamily:F.family, color:T.textGray, margin:0 }}>📅 {m.disponibilidad}</p>
                  </div>
                  <div style={{ width:24, height:24, borderRadius:"50%", border:`2px solid ${medicoId===m.id ? T.primary : T.primaryLt}`, background: medicoId===m.id ? T.primary : "transparent", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0 }}>
                    {medicoId===m.id && <span style={{ color:"white", fontSize:12, fontWeight:800 }}>✓</span>}
                  </div>
                </div>
              </div>
            ))}
            ...
            <div style={S.card}>
              ...
              {[
                { n:"1", txt:"Elige el médico de tu preferencia" },
                { n:"2", txt:"Completa el formulario con tu motivo de consulta y horario preferido" },
                { n:"3", txt:"Realiza el pago de la consulta por PayPal o Pago Móvil" },
                { n:"4", txt:"Envía el comprobante de pago por WhatsApp" },
                { n:"5", txt:"Nuestro equipo médico confirmará tu cita y te contactará a la hora acordada" },
                { n:"6", txt:"Recibe tu consulta, diagnóstico y prescripción desde casa" },
              ].map((p,i) => (
                <div key={i} style={{ display:"flex", gap:12, padding:"10px 0", borderBottom:i<5?`1px solid ${T.primaryLt}`:"none", alignItems:"flex-start" }}>
            ...
            <button
              style={{ ...S.btnPrimary, opacity: medicoId ? 1 : 0.5 }}
              onClick={() => { if(medicoId) setPaso(1); }}>
              {medicoId ? `Continuar con ${medico?.nombre} →` : "Selecciona un médico para continuar"}
            </button>
          </>
        )}
        ...
        {paso === 1 && (
          <div style={S.card}>
            <p style={{ ...F.label, fontFamily:F.family, color:T.primary, marginBottom:6 }}>Paso 1 de 2</p>
            <h2 style={{ ...F.h2, fontFamily:F.family, color:T.textHd, margin:"0 0 4px" }}>Tu solicitud de cita</h2>
            <p style={{ ...F.body, fontFamily:F.family, color:T.textBody, margin:"0 0 6px" }}>
              Médico: <strong>{medico?.nombre}</strong>
            </p>
            <p style={{ ...F.sm, fontFamily:F.family, color:T.textGray, margin:"0 0 20px" }}>{medico?.especialidad}</p>
            ...
            <div style={{ marginBottom:16 }}>
              ...
              <input style={S.input} type="date" value={form.fecha} onChange={e=>campo("fecha",e.target.value)} min={new Date().toISOString().split("T")[0]}/>
            </div>
            <div style={{ marginBottom:20 }}>
              ...
              <div style={{ display:"flex", flexWrap:"wrap", gap:7 }}>
                {horas.map(h => <button key={h} onClick={() => campo("hora",h)} style={{ ...S.btnSecondary(form.hora===h), borderRadius:10 }}>{h}</button>)}
              </div>
            </div>
        ...
        {paso === 2 && (
          <>
            <div style={S.card}>
              <p style={{ ...F.label, fontFamily:F.family, color:T.primary, marginBottom:6 }}>Paso 2 de 2</p>
              <h2 style={{ ...F.h2, fontFamily:F.family, color:T.textHd, margin:"0 0 20px" }}>Realiza tu pago</h2>
              ...
              <p style={{ ...F.body, fontFamily:F.family, color:T.textBody, marginBottom:16, lineHeight:1.6 }}>
                📸 Envía el <strong>comprobante por WhatsApp</strong> para confirmar tu cita.
              </p>
              ...
              <button onClick={() => setPaso(3)} style={S.btnGold}>✓ Ya realicé mi pago</button>
            </div>
        ...
        {paso === 3 && (
          <div style={{ textAlign:"center", padding:"20px 0" }}>
            ...
            <p style={{ ...F.body, fontFamily:F.family, color:T.textBody, marginBottom:24, lineHeight:1.7 }}>
              Nuestro equipo médico revisará tu comprobante y confirmará tu cita. Recibirás confirmación en las próximas horas.
            </p>

            <div style={{ ...S.card, textAlign:"left" }}>
              <p style={{ ...F.label, fontFamily:F.family, color:T.primary, marginBottom:12 }}>Resumen de tu cita</p>
              {[
                { l:"Médico",           v: medico?.nombre || "—" },
                { l:"Especialidad",     v: medico?.especialidad || "—" },
                { l:"Fecha preferida",  v: form.fecha || "Por confirmar" },
                { l:"Horario preferido",v: form.hora  || "Por confirmar" },
                { l:"Monto pagado",     v: "$25 USD" },
                { l:"Modalidad",        v: "Videollamada · Google Meet" },
              ].map(f => (
            ...
            {/* Botón videollamada */}
            <div style={{ ...S.card, background:"linear-gradient(135deg, #E8F5E9, #F1F8E9)", border:"1px solid #A5D6A7", marginTop:14, textAlign:"left" }}>
              <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:12 }}>
                <span style={{ fontSize:28 }}>🎥</span>
                <div>
                  <p style={{ ...F.h3, fontFamily:F.family, color:"#1B5E20", margin:"0 0 2px" }}>Tu videollamada</p>
                  <p style={{ ...F.sm, fontFamily:F.family, color:"#388E3C", margin:0 }}>Google Meet · Únete a la hora acordada</p>
                </div>
              </div>
              <a href={medico?.meet || "#"} target="_blank" rel="noopener noreferrer" style={{ textDecoration:"none" }}>
                <button style={{ ...S.btnPrimary, background:"linear-gradient(135deg, #43A047, #2E7D32)", boxShadow:"0 4px 14px rgba(67,160,71,0.3)", width:"100%" }}>
                  🎥 Unirse a la videollamada
                </button>
              </a>
              <p style={{ ...F.sm, fontFamily:F.family, color:"#558B2F", margin:"10px 0 0", textAlign:"center" }}>
                Úsalo a la hora de tu cita confirmada
              </p>
            </div>

            <button onClick={() => { setPaso(0); setMedicoId(null); setForm({ motivo:"", fecha:"", hora:"" }); }}
      ...
      <div style={{ padding:"0 16px" }}>
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10, marginBottom:14 }}>
          {[
            ...
            { icon:"⚥",  label:"Sexo", val:perfil?.sexo||"—" },
          ].map(s => (
        ...
        <div style={{ background:"#FEF2F2", border:"1px solid #FECACA", borderRadius:14, padding:16, marginBottom:14 }}>
          <p style={{ ...F.sm, fontFamily:F.family, color:"#991B1B", margin:0, lineHeight:1.6 }}>
            🚨 <strong>Emergencias:</strong> Vela no atiende emergencias médicas. Llama al <strong>911</strong> o ve al hospital más cercano.
          </p>
        </div>
        ...
        <div style={{ background:T.bgMuted, borderRadius:16, padding:16, marginBottom:14, border:`1px solid ${T.primaryLt}` }}>
          <p style={{ ...F.sm, fontFamily:F.family, color:T.textBody, margin:0, lineHeight:1.7 }}>
            🛡️ <strong>Aviso legal:</strong> Vela es una plataforma de orientación médica e información en salud. Las consultas médicas son servicios profesionales prestados por médicos registrados. Vela no se hace responsable de decisiones médicas tomadas sin consultar a un profesional.
          </p>
        </div>

        <p style={{ ...F.sm, fontFamily:F.family, color:T.textGray, textAlign:"center", margin:"0 0 14px", opacity:0.6 }}>
          Fundadora de Vela Salud: Dra. Guilliana Matute
        </p>
...
export default function VelaVenezuela() {
  ...
  const tabs = {
    ...
    consultar: <Consultar state={state} dispatch={dispatch} onNavegar={setTab}/>,
